...
export function CatalogosView() {
    ...
    const totalGrupos = data?.totalCount ?? 0
    ...
    return (
        <div className="catalogos-view">
            <header className="catalogos-view__header">
                ...
                >
                    <Flex align="center" gap={16}>
                        <div className="catalogos-view__header-icon" aria-hidden>
                            <DatabaseOutlined />
                        </div>
                        <div>
                            <Title level={3} className="catalogos-view__title">
                                Catálogos
                            </Title>
                            <Text type="secondary">
                                Administre grupos de catálogo y sus ítems del sistema.
                            </Text>
                        </div>
                    </Flex>

                    <Flex gap={12} wrap="wrap" className="catalogos-view__header-stats">
                        <div className="catalogos-view__stat">
                            <Statistic
                                title="Grupos"
                                value={totalGrupos}
            ...
            <div className="catalogos-view__workspace">
                <Row gutter={[20, 20]} className="catalogos-view__master-detail">
                    <Col xs={24} lg={9} xl={8}>
                        <section className="catalogos-view__panel catalogos-view__panel--master">
                            <div className="catalogos-view__panel-toolbar">
                                <div>
                                    ...
                                    <Text type="secondary" className="catalogos-view__panel-caption">
                                        {totalGrupos} registrado{totalGrupos === 1 ? '' : 's'}
                                    </Text>
                                </div>
                                <Button
                                    type="primary"
                    ...
                    <Col xs={24} lg={15} xl={16}>
                        <section
                            className={[
                                ...
                                selectedGrupo ? 'catalogos-view__panel--active' : '',
                            ]
                                .filter(Boolean)
                                .join(' ')}
                        >
                            {selectedGrupo ? (
                                <>
                                    <div className="catalogos-view__detail-hero">
                                        <Flex
                                            justify="space-between"
                                            align="flex-start"
                                            gap={16}
                                    ...
                                    <div className="catalogos-view__detail-body">
                                        <Flex
                                            justify="space-between"
                                            align="center"
                                            className="catalogos-view__detail-section-head"
                                        >
                                            <Text strong>Ítems del catálogo</Text>
                                            <Text type="secondary" className="catalogos-view__detail-count">
                                ...
                                <div className="catalogos-view__empty">
                                    ...
                                    <Empty
                                        ...
                                        description={
                                            <Flex vertical gap={6} align="center">
                                                ...
                                                >
                                                    Elija un grupo en el panel izquierdo para explorar y
                                                    administrar sus ítems.
                                                </Paragraph>
                                            </Flex>
                                        }
                                    />
